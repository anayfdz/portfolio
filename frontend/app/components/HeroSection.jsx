  ...
  return (
    ...
    />
        ...
        <div className="col-span-5 place-self-center mt-4 lg:mt-0">
          <div className="rouded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image src="/logo.png" width={300} height={300} alt="hero image" className="absolute transform -translate-x-1/2 translate-y-1/2 top-1/2 left-1/2" />
          </div>
        </div>
      </div>
    </section>
